...
grader.addManualPart('2c', 3, extraCredit = True) # Remove discount
...
grader.addBasicPart('3a', test3a, 5, description="Basic test for succAndProbReward() that covers several edge cases.")
...
grader.addBasicPart('3b', test3b, 4, description="Test for peekingMDP().  Ensure that in at least 10% of states, the optimal policy is to peek.")
...
grader.addBasicPart('4a', test4a, 5, maxSeconds=10, description="Basic test for incorporateFeedback() using NumberLineMDP.")
...
grader.addBasicPart('4c', test4c, 5, maxSeconds=10, description="Basic test for blackjackFeatureExtractor.  Runs QLearningAlgorithm using blackjackFeatureExtractor, then checks to see that Q-values are correct.")
"""
